...
@Component({
    ...
    standalone   : true,
    imports      : [SeniorLoadingBarComponent, NgIf, SeniorVerticalNavigationComponent, SeniorHorizontalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, SeniorFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, RouterOutlet, QuickChatComponent],
})
