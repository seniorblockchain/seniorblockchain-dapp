...
@Component({
    ...
    standalone   : true,
    imports      : [SeniorLoadingBarComponent, SeniorVerticalNavigationComponent, MatButtonModule, MatIconModule, LanguagesComponent, SeniorFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, NgIf, RouterOutlet, QuickChatComponent],
})
