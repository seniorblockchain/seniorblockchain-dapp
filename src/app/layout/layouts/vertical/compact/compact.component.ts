...
@Component({
    ...
    standalone   : true,
    imports      : [SeniorLoadingBarComponent, MatButtonModule, MatIconModule, LanguagesComponent, SeniorFullscreenComponent, SearchComponent, ShortcutsComponent, MessagesComponent, NotificationsComponent, UserComponent, NgIf, RouterOutlet, QuickChatComponent, SeniorVerticalNavigationComponent],
})
